package com.huifer.baseweb.config;
...
import com.huifer.baseweb.constants.BaseConstants.DateFormat;
import com.huifer.baseweb.intercepter.HttpServletRequestFilter;
import com.huifer.baseweb.intercepter.SiteHandlerInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
  ...
  private FastJsonConfig fastjsonConfig() {
    ...
    JSONObject.DEFFAULT_DATE_FORMAT = DateFormat.DEFAULT_FORMAT;
...
//                SerializerFeature.WriteNullNumberAsZero,
    ...
    result.setDateFormat(DateFormat.DEFAULT_FORMAT);
